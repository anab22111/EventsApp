...
public class AppData {
    ...
    static{
        ...
        allEvents.add(EventFactory.createPromotedEvent("Ultra Europe", "Music festival", "Split, Croatia", "10.07.2026. 20:00", "Festival", R.drawable.festival, 50000));
        ...
        allEvents.add(EventFactory.createRegularEvent("Exit", "Biggest music festival in Serbia", "Petrovaradin, Novi Sad", "15.07.2026. 18:00", "Festival", R.drawable.festival));
        ...
        allEvents.add(EventFactory.createRegularEvent("Fruska gora marathon", "49th Fruska Gora marathon", "Fruska Gora, Popovica", "25.04.2026. 09:00", "Marathon", R.drawable.marathon));  //prosao
        ...
        allEvents.add(EventFactory.createRegularEvent("Durmitor marathon", "50th Durmitor marathon", "Durmitor, Montenegro", "25.08.2026. 09:00", "Marathon", R.drawable.marathon));
        ...
        allEvents.add(EventFactory.createRegularEvent("Beer Fest", "Belgrade traditional beer and music festival", "Ušće, Belgrade", "15.08.2026. 18:00", "Festival", R.drawable.festival));
        ...
        allEvents.add(EventFactory.createRegularEvent("Belgrade Marathon", "42km race through the city", "Center, Belgrade", "17.05.2026. 08:00", "Marathon", R.drawable.marathon));
        allEvents.add(EventFactory.createRegularEvent("Wine Fest 2024", "Annual wine tasting event", "City Center, Novi Sad", "15.03.2024. 14:00", "Festival", R.drawable.festival));
